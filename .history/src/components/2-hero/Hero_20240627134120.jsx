  ...
  return (
    <section className="hero flex">
      <div className="left-section  ">
        ...
        <a target="_blank" href="https://www.linkedin.com/in/fady-fathey-maher-72918916b/" rel="noreferrer"> <div className="icon icon-linkedin"></div></a>
        <i  className="fa-solid fa-file icon" ><img src="../../../public/Fady_Fathey_Maher_CV_Front-End.pdf" alt="" /></i>
        </div>
      </div>
